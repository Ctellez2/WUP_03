...
The P value represents the chances of getting a result like we just obtained if the null hypothesis is actually true. Since the resulting number is significantly small, I am going to reject the null hypothesis. We know need to look for which two are different from each other.
```{r}
